...
**NOTE**
This maintenance of this library has moved over to [katangensis](https://github.com/katangensis/fhttp). The only use for this repository is so imports will not break.
